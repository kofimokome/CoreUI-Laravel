            ...
            <ul class="nav">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/breadcrumb')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/carousel')}}">
                                <i class="nav-icon icon-puzzle"></i> Carousel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/collapse')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/jumbotron')}}">
                                <i class="nav-icon icon-puzzle"></i> Jumbotron</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/list-group')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/pagination')}}">
                                <i class="nav-icon icon-puzzle"></i> Pagination</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/popovers')}}">
                                <i class="nav-icon icon-puzzle"></i> Popovers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/progress')}}">
                                <i class="nav-icon icon-puzzle"></i> Progress</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/scrollspy')}}">
                                <i class="nav-icon icon-puzzle"></i> Scrollspy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/switches')}}">
                                <i class="nav-icon icon-puzzle"></i> Switches</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/tables')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/base/tooltips')}}">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('buttons/button-group')}}">
                                <i class="nav-icon icon-cursor"></i> Buttons Group</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('buttons/dropdowns')}}">
                                <i class="nav-icon icon-cursor"></i> Dropdowns</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('buttons/brand-buttons')}}">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('icons/coreui-icons')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('icons/font-awesome')}}">
                                <i class="nav-icon icon-star"></i> Font Awesome
                                <span class="badge badge-secondary">4.7</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('icons/simple-line-icons')}}">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('notifications/alerts')}}">
                                <i class="nav-icon icon-bell"></i> Alerts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('notifications/badge')}}">
                                <i class="nav-icon icon-bell"></i> Badge</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('notifications/modals')}}">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/500')}}" target="_top">
